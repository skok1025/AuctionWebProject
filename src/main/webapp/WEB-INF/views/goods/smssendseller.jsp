...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%> 
    ...
    if(action.equals("go")) {
        ...
        String rdate = base64Encode(nullcheck(request.getAttribute("rdate").toString(), ""));
        String rtime = base64Encode(nullcheck(request.getAttribute("rtime").toString(), ""));
   ...
   <script>
   	...
   	location.href='/spring/index123.action';
